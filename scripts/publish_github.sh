...
release_description=$(curl --header "PRIVATE-TOKEN: $GITLAB_PRIVATE_TOKEN_AK" "https://gitswarm.f5net.com/api/v4/projects/cloudsolutions%2Fautomation-templates%2Ff5-bigip-runtime-init/releases/$CI_COMMIT_REF_NAME" | jq .description)
